  ...
  register: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      update: function update(dt) {
        ...
        "" != this._email.trim() && "" != this._passWord.trim() && true == this.checkEmail() ? this.btnRegister.getComponent(cc.Button).interactable = true : this.btnRegister.getComponent(cc.Button).interactable = false;
      },
